...
public class MultiImageSelectTwoActivity extends Activity {
...
//                        .multi()
//                        .origin(mResults)
//                        .start(MultiImageSelectTwoActivity.this, REQUEST_CODE);


                // start multiple photos selector
                Intent intent = new Intent(MultiImageSelectTwoActivity.this, ImagesSelectorActivity.class);
