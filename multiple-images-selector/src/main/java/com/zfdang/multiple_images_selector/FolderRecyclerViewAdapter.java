...
public class FolderRecyclerViewAdapter extends RecyclerView.Adapter<FolderRecyclerViewAdapter.ViewHolder> {
    ...
    public FolderRecyclerViewAdapter(Activity activity, List<FolderItem> items, OnFolderRecyclerViewInteractionListener listener) {
        mValues = items;
        mListener = listener;
        mActivity = activity;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        Glide.with(mActivity).load(folderItem.coverImagePath).crossFade().centerCrop().into(holder.folderCover);
