...
public class ImageRecyclerViewAdapter extends RecyclerView.Adapter<ImageRecyclerViewAdapter.ViewHolder> {
    ...
    public ImageRecyclerViewAdapter(Activity activity, List<ImageItem> items, OnImageRecyclerViewInteractionListener listener) {
        mValues = items;
        mListener = listener;
        mActivity = activity;
    }
...
//            DraweeUtils.showThumb(newURI, holder.mDrawee);
            ...
            Glide.with(mActivity).load(newURI).centerCrop().crossFade().into( holder.mDrawee);
...
//            DraweeUtils.showThumb(newURI, holder.mDrawee);
            Glide.with(mActivity).load(R.drawable.ic_photo_camera_white_48dp).centerCrop().crossFade().into( holder.mDrawee);
